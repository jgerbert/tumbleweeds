...
createPaddles() {
  ...
  gameLoop() {
    ...
    // Update the collision effect (particles)
    this.collisionHandler.updateCollisionEffect(); // Call the update method for collision effects
    ...
    if (this.tumbleweed) {
        ...
        this.tumbleweed.trail.unshift({
            ...
            opacity: 0.38 // Opacity of the trail
        });
    ...
    // Render the collision effect (particles)
    this.collisionHandler.renderCollisionEffect(this.gameStageView.context); // Render collision effects
